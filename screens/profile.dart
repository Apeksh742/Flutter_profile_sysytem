...
class _ProfileState extends State<Profile> {
  String name = 'Ankush', country = 'India', city = 'Jaipur', phoneNumber = '+ 91-9876543210';
  ...
  _profile() {
    return Container(
      ...
      child: ListView(padding: EdgeInsets.all(10.0), children: <Widget>[
        ...
        Center(child: RaisedButton(onPressed: _launchURL,
         child: Text ("Dial on number pad"),color: Colors.red,)),
        SizedBox(height: 15.0),
        SizedBox(width: 10.0),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
          ...
          Row(
              children: [Row(
                children: [
                  Text('1458913543'),
                  IconButton(icon: Icon(Icons.content_paste),  onPressed: () => _copyToClipboard('userId'))
                ],
              ),]
              ),
        ]),
